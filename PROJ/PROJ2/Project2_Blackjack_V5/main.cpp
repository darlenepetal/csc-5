 ...
 * Created on February 10, 2024, 11:10 AM
 * Purpose: Project2_Blackjack_V5
 */
...
int main(void) {
    ...
    while (true) {
        ...
        do {
            ...
            if (hndOver && dlrTotl==17 && dlrSoft == true) 
                hndOver = false;
            if (hndOver || usrStnd || usrTotl > 20)
                dlrShow = true;
            if (usrStrs.size()<5 && usrTotl==21 && usrSoft)
                dlrShow = false;
            ...
            if (!usrStnd && !dlrShow && !hndOver) {
                ...
                if (usrCash>=betAmnt && usrStrs.size()==2) {
                ...
                do {
                    ...
                    switch (usrInpt) 
                    {
                        ...
                        case 'D':   if (usrCash<betAmnt || usrStrs.size()!=2) {
                                        validIn = false;
                                    }
                                    else {
            ...
            if (dlrShow && !hndOver) {
                ...
                if (dlrTotl < 17 || (dlrTotl == 17 && dlrSoft)) {
