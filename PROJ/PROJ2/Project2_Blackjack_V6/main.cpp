 ...
 * Created on February 10, 2024, 1:56 PM
 * Purpose: Project2_Blackjack_V6
 */
...
//        }
        ...
        do {
            ...
            if (usrStnd || usrTotl>20)
                dlrShow = true;
            if (usrCrds<5 && usrCrds>2 && usrTotl==21 && usrSoft)
                dlrShow = false;
            ...
            if (dlrShow && dlrTotl<17 || (dlrTotl==17 && dlrSoft)) {
