 ...
 * Created on January 29, 2024, 12:27 PM
 * Purpose: Project1_Blackjack_V5
 */
        ...
        */
        ...
        do {
            ...
            for (char curCard = char(1); curCard <= usrCrds+2; curCard++) {
                ...
                tempVal = (tempVal-1)%13+1;
                if (tempVal > 10) tempVal = 10;
                else if (tempVal == 1) uHasAce = true;

                usrHand += tempVal;
                if (usrHand <= 11 && uHasAce) usrHand += 10;
            }
            inVals.close();
            ...
            (usrHand == 21)             ? hndOver = true :
            (dlrHand == 21)             ? hndOver = true : hndOver = false;
            
            if (usrStnd || dblDown || hndOver) dlrShow = true;
                ...
                do {
                    ...
                    if (validIn == false) {
                        if (usrInpt == 'd' || usrInpt == 'D') {
                            cout << "You need to have more than" << endl;
